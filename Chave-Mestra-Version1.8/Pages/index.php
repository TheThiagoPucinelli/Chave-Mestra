    ...
    <form method="post">
      ...
      <div class="grid md:grid-cols-3 gap-4">
        <div>
          ...
          <input list="chaves_agendadas" name="chave_texto" required class="w-full p-2 border rounded">
    ...
    <form method="post">
      ...
      <div class="grid md:grid-cols-2 gap-4 items-end">
        <div>
          ...
          <input list="chaves_devolucao" name="chave_texto_devolucao" required class="w-full p-2 border rounded">
